...
$ ls ./setun1958emu
205000 мар 30 22:28 ./setun1958emu
```
...
## 3.3. 'test' или 't' - запуск теста для проверки библиотеки функций эмулятора SETUN-1958 
...
## 3.5. 'begin' или 'b' - начальный запуск программы с виртуального фотосчитывателя 'ptr1' эмулятора SETUN-1958
