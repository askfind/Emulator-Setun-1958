...
## 22.08.2023
- [X] Изменена команда 'calc'. Калькулятор "MK-Setun-01", с использованием ИП-2.
- [X] Реализована команда 'debug'.
- [X] Добавить параметры в деветяричном виде для команд 'fram', 'drum'.
